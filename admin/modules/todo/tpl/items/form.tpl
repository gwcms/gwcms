...
{$users = GW::$user->getOptions(true)}


{include file="elements/input.tpl" type=select name=user_create empty_option=1 options=$users default=GW::$user->id data_type=numeric}
...
<table class="gwTable" style="width:100%">
	...
	<tr>
		<td>
			<script type="text/javascript" src="js/jquery.iframe-auto-height.plugin.1.5.0.js"></script>
			
			<iframe id="comments" style="width:100%;height:250px" src="{$ln}/{GW::$request->path}/{$m->parent->id}/comments" frameborder="0"></iframe>
