...
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4781850305056a7e3066f39-71727526',
  'function' => 
  array (
    'dl_cell_state' => 
    array (
...
<?php $_smarty_tpl->tpl_vars['link'] = new Smarty_variable(FH::gw_link(array('params'=>array('pid'=>$_smarty_tpl->getVariable('item')->value->id),'path_only'=>1)), null, null);?>

	<?php $_smarty_tpl->tpl_vars['users'] = new Smarty_variable(GW::$user->getOptions(), null, null);?>

	<?php if (!function_exists('smarty_template_function_dl_cell_state')) {
    function smarty_template_function_dl_cell_state($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->template_functions['dl_cell_state']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
				<?php echo $_smarty_tpl->getVariable('m')->value->lang['STATE_OPT'][$_smarty_tpl->getVariable('item')->value->state];?>
<?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;}}?>
    ...
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
		...
		<?php if ($_smarty_tpl->getVariable('item')->value->type==1){?>
...
"><?php echo $_smarty_tpl->getVariable('item')->value->title;?>
 (Enter)</a>
	...
	<?php if (!function_exists('smarty_template_function_dl_cell_user_create')) {
    function smarty_template_function_dl_cell_user_create($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->template_functions['dl_cell_user_create']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
				<?php echo $_smarty_tpl->getVariable('users')->value[$_smarty_tpl->getVariable('item')->value->user_create];?>
<?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;}}?>
	
	

	<?php if (!is_callable('smarty_function_gw_link')) include '/var/www/gw_cms/admin/lib/smarty/plugins/function.gw_link.php';
?><?php if (!function_exists('smarty_template_function_dl_cell_actions1')) {
    function smarty_template_function_dl_cell_actions1($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->template_functions['dl_cell_actions1']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
		<?php if ($_smarty_tpl->getVariable('item')->value->user_exec==GW::$user->id){?>
			<?php if (((int)$_smarty_tpl->getVariable('item')->value->state<100)){?>
				<?php echo smarty_function_gw_link(array('do'=>'complete','params'=>array('id'=>$_smarty_tpl->getVariable('item')->value->id),'title'=>"Fix"),$_smarty_tpl);?>

			<?php }?>
		<?php }else{ ?>
			<?php echo smarty_function_gw_link(array('do'=>'execute','params'=>array('id'=>$_smarty_tpl->getVariable('item')->value->id),'title'=>"Exec"),$_smarty_tpl);?>

		<?php }?><?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;}}?>
	
	

	<?php if (!function_exists('smarty_template_function_dl_cell_user_exec')) {
    function smarty_template_function_dl_cell_user_exec($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->template_functions['dl_cell_user_exec']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
				<?php echo $_smarty_tpl->getVariable('users')->value[$_smarty_tpl->getVariable('item')->value->user_exec];?>
<?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;}}?>
	

	<?php $_smarty_tpl->tpl_vars['dl_smart_fields'] = new Smarty_variable(array('state','user_create','user_exec','title','actions1'), null, null);?>
	
	
	<?php $_smarty_tpl->tpl_vars['display_fields'] = new Smarty_variable(array('id'=>1,'priority'=>1,'title'=>1,'state'=>1,'deadline'=>1,'insert_time'=>1,'update_time'=>1,'user_create'=>1,'user_exec'=>1,'actions1'=>1), null, null);?>	
...
$_smarty_tpl->tpl_vars['dl_toolbar_buttons']->value[] = 'dialogconf';?>
	...
	<?php $_smarty_tpl->tpl_vars['dl_actions'] = new Smarty_variable(array('edit','delete'), null, null);?>
	
	
	<?php $_smarty_tpl->tpl_vars['dl_filters'] = new Smarty_variable($_smarty_tpl->getVariable('display_fields')->value, null, null);?>
	
	<?php $_smarty_tpl->tpl_vars['dl_order_enabled_fields'] = new Smarty_variable(array_keys($_smarty_tpl->getVariable('display_fields')->value), null, null);?>
