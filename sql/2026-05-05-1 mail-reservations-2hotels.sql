...
SELECT
	'competitions/accommodation',
	'mailtohotels',
	'mail-reservations-2hotels',
	'mail-reservations-2hotels',
	0,
	'',
	'',
	'',
	'',
	'{$COMPETITION_TITLE} - rezervacijos viešbučiui {$HOTEL_TITLE}',
	'{$COMPETITION_TITLE} - accommodation reservations for {$HOTEL_TITLE}',
	'',
	'<!DOCTYPE html>
<html lang="lt">
<head>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding:30px 0;background-color:#e9edf3;background-image:url("https://www.transparenttextures.com/patterns/subtle-dots.png");background-repeat:repeat;">
	...
	2,
	'600px',
	'COMPETITION_TITLE, COMPETITION_IMAGE, HOTEL_TITLE, HOTEL_NAME, HOTEL_ADDRESS, HOTEL_RESERVATION_COUNT, HOTEL_RESERVATION_GROUPS, ROOM_TITLE, ROOM_TITLES, ROOM_TITLES_TEXT',
	0,
	'',
	'[]',
	0,
