...
{function user_login_form}
	...
	<div class="g-brd-around g-brd-gray-light-v3 g-bg-white rounded g-px-30 g-py-50 mb-4">
		      ...
		      <input type="hidden" name="act" value="do:verifyCode" />
                <div class="mb-4">
                  <div class="input-group g-rounded-left-3">
                    ...
                    <input name="phone" 
			   class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-rounded-left-0 g-rounded-right-3 g-py-15 g-px-15" type="email" 
		...
		<div class="mb-4">
			   ...
			   name="code" placeholder="{GW::ln('/m/ENTER_CODE_HERE')}" required="1">
                  </div>
                </div>		
               
               <div class="mb-5">
                  <button class="btn btn-block u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button" onclick="$('#smsCodeForm').submit()">
			  {GW::ln('/m/VERIFY_SMS_CODE')}
		  </button>
                </div>
{/function}
