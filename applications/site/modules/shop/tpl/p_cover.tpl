...
{function crowd_funding_block}
	...
	<!-- Progress Bar -->
			...
			<div class="clearfix text-uppercase g-color-danger g-font-size-11">
			  ...
			  <em class="float-right g-font-style-normal g-font-weight-600">
			    <span class="g-color-primary">{round($progress)}%</span></em>
...
<div class="container g-pt-20 g-pb-100">
		...
		<div class="col-md-12">
			<center>
				{$img = $item->image}
	<img style='width:100%'
	     src="{$app_base}tools/img/{$img->key}&v={$img->v}" 
	...
	<div class='row'>
		<div class='col-md-4 '>
			...
			<!-- List -->
				...
				{call modifications_block}
				
				{call price_block}
			</div>
		</div>	
		<div class="col-md-8">
			{call description_block}
		</div>
