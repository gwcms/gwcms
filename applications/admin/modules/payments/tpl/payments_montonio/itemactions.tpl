...
{if $m->write_permission}	
	...
	{list_item_action_m href="{$ln}/direct/orders/orders?act=doMontonioRetryProcess&id={$item->id}" iconclass="fa fa-refresh" caption=GW::l('/g/VIEWS/doMontonioRetryProcess')}
