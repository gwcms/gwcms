...
{assign var=width_title value="110px" scope=global}
...
{capture assign=tmp}
		...
		<table class="gwTable" style='width:100%'>
			<tr>
				<th>{GW::l('/m/FIELDS/obj_type')}</th>
				<th>{GW::l('/m/FIELDS/invoice_line2')}</th>
				<th>{GW::l('/m/FIELDS/qty')}</th>
				<th>{GW::l('/m/FIELDS/unit_price')}</th>
				<th>{GW::l('/m/FIELDS/total')}</th>
			</tr>
