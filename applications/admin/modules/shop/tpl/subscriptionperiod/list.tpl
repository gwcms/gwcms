...
{block name="init"} 
	...
	{function name=do_toolbar_buttons_modules} 
		{toolbar_button title="Sukurti periodą" iconclass='gwico-Upload-SVG' href=$m->buildUri(false,[act=>doAddPeriod])}
	{/function}		
...
{$dl_smart_fields=[period,orders,image,type]} 
