...
<table class="login_frm">
	<tr>
		<td style="padding-right: 10px">{GW::l('/g/USER')}</td>
	...
	<tr>
		<td style="padding-right: 10px">{GW::l('/g/PASS')}</td>
