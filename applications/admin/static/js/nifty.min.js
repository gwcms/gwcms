// nifty.min.js nifty.js FIXED to work with REQUIRE.JS REQUIREJS
/* REQUIRED PLUGINS
/* ========================================================================
            ...
            'bind' : function(){
                ...
                try {
 				 ...
 				 scrollbar = $('#mainnav-menu-wrap > .nano');
                   if(scrollbar.length) 
					   scrollbar.nanoScroller({ preventPageScrolling : (niftyContainer.hasClass('mainnav-fixed')?true:false)});   						
					})
