		...
		<table class="gwTable mar-top" style="width:100%">
			...
			<tr>
				<td style="border: 1px solid white;background-color:#f9f9f9">
					...
					<iframe id="comments" style="width:100%;height:250px;" src="{$app->buildURI("datasources/comments/list?obj_type={$m->model->table}&obj_id=0&clean=2")}" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
