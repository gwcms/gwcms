...
class GW_Sum_To_Text_Helper {
	...
	function sum2Text($number, $lang='lt')
	{
	...
	function getCurrencyLT($number, $begin = 'eur') {
		if ($number == 0)
			return $begin . 'ų';
	...
	function getCurrencyEN($number, $begin = 'eur') {
